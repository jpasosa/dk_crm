<link href="/css/dis_imp_arte_fabrica.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/js/dis_imp_arte_fabrica/del_file.js"></script>
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <hr />
        <h1 class="azul bold"><span class="txt22 normal">Implementación de Arte por Fábrica</span></h1>
        <hr />
        <p class="txt10 uppercase">Fecha de inicio del trámite:<span class="azul"> {$date}</span></p>
        <p>Sector:<span class="azul"> {$area}</span></p>
        <p>Nombre:<span class="azul"> {$nombre_empleado}</span></p>
        <form class="box-entrada" action="/dis_imp_arte_fabrica.html" method="post" enctype="multipart/form-data" >
                ...
                {if $files['error'] == false }
                    <div class="archivos">
                        {foreach item=n from=$files}
                            <div class="file">
                                <a class="file_name" target="_blank" id="file_name-{$$n[id]}" href="/upload_archivos/dis_imp_arte_fabrica/{$$n[nombre]}">
        ...
        <form class="box-entrada" name="add_hotel" action="/dis_imp_arte_fabrica.html" method="post" enctype="multipart/form-data" >
