<link href="/css/dis_recibir_trabajar_artes.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/js/dis_recibir_trabajar_artes/del_file.js"></script>
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <hr />
        <h1 class="azul bold"><span class="txt22 normal">Recibir y Trabajar Artes</span></h1>
        <hr />
        <p class="txt10 uppercase">Fecha de inicio del trámite:<span class="azul"> {$date}</span></p>
        <p>Sector:<span class="azul"> {$area}</span></p>
        <p>Nombre:<span class="azul"> {$nombre_empleado}</span></p>
        <form class="box-entrada" action="/dis_recibir_trabajar_artes.html" method="post" enctype="multipart/form-data" >
            <div class="box-entrada" height="40" colspan="5" bgcolor="#D2E1F2">
                ...
                <a href="file_download/{$pr_proceso}/error404.jpg.html">
                    <span>Archivo</span>
                </a>
                {if $files['error'] == false }
                    <div class="archivos">
                        {foreach item=n from=$files}
                            <div class="file">
                                <a class="file_name" target="_blank" id="file_name-{$$n[id]}" href="/upload_archivos/dis_recibir_trabajar_artes/{$$n[nombre]}">
        ...
        <form class="box-entrada" name="add_hotel" action="/dis_recibir_trabajar_artes.html" method="post" enctype="multipart/form-data" >
