...
<script type="text/javascript" src="/js/rh_rendicion_dias_enfermedad/del_file.js"></script>
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(/img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <form class="box-entrada" action="/rh_rendicion_dias_enfermedad.html" method="post" enctype="multipart/form-data" >
            <div class="box-entrada padding10" height="40" colspan="5" bgcolor="#D2E1F2">
                ...
                <div class="der">
                    <div class="campania">
                        ...
                        <input name="cant_dias" type="text" value='{$tabla[0]['cantidad_dias']}'  alt="Cantidad Días" />
                    </div>
                </div>
                <div class="izq">
                    <div class="campania">
