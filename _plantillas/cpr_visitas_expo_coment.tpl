...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;" >
            ...
            <div class="box-entrada padding10   " height="40" colspan="5" bgcolor="#D2E1F2">
                <div class="izq">
                    <div class="campania">
                        ...
                        <input readonly="readonly" name="expo" type="text" value='{$tabla[0]["exposicion"]}'  alt="Exposición" />
                    </div>
                    <div class="campania">
        ...
        <form class="box-coment" name="box_coment" action="/cpr_visitas_expo_coment/{$id_tabla_proc}.html" method="post" enctype="multipart/form-data" >
