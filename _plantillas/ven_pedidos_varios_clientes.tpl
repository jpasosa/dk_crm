...
<script type="text/javascript" src="/js/ven_pedidos_varios_clientes/del_file.js"></script>
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;">
        ...
        <form class="box-entrada" action="/ven_pedidos_varios_clientes.html" method="post" enctype="multipart/form-data" >
                ...
                {if $files['error'] == false }
                    <div class="archivos">
                        {foreach item=n from=$files}
                            <div class="file">
                                <a class="file_name" target="_blank" id="file_name-{$$n[id]}" href="/upload_archivos/ven_pedidos_varios_clientes/{$$n[nombre]}">
