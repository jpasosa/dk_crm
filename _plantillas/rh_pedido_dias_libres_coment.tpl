<link href="/css/rh_pedido_dias_libres.css" rel="stylesheet" type="text/css" />
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <hr />
        <h1 class="azul bold"><span class="txt22 normal">Pedido de días Libres</span></h1>
        <hr />
        ...
        <form class="box-entrada" action="/rh_pedido_dias_libres.html" method="post" enctype="multipart/form-data" >
            <div class="box-entrada" height="40" colspan="5" bgcolor="#D2E1F2">
                <div class="fecha_inicio">
                    <label>Fecha Inicio: </label>
                    <input name="fecha_inicio" id="fecha_inicio" class="fecha_inicio" readonly="readonly" value='{$tabla[0][fecha_inicio]|date_format:"d/m/Y"}' />
                </div>
                <div class="fecha_fin">
                    <label>Fecha Fin: </label>
                    <input name="fecha_fin" type="text" id="fecha_fin" readonly="readonly" value='{$tabla[0][fecha_fin]|date_format:"d/m/Y"}' />
                </div>
                <div class="cant_dias">
                    <label>Cantidad Días: </label>
                    <input name="cant_dias" type="text" readonly="readonly" value="{$tabla[0]['cantidad_dias']}" />
                </div>
                ...
                {if $files['error'] == false }
                    <div class="archivos">
                        {foreach item=n from=$files}
                            <div class="file">
                                <a class="file_name" target="_blank" id="file_name-{$$n[id]}" href="/upload_archivos/rh_pedido_dias_libres/{$$n[nombre]}">
        ...
        <form class="box-coment" name="box_coment" action="/rh_pedido_dias_libres_coment/{$id_tabla_proc}.html" method="post" enctype="multipart/form-data" >
