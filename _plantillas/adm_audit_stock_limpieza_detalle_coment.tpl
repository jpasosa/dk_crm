...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
	...
	<div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;" >
		...
		<form class="box-entrada" action="/adm_audit_stock_limpieza_detalle/{$adm_audit_stock_limpieza['id_adm_audit_stock_limpieza']}.html"
			...
			<div class="box-entrada padding10   " height="40" colspan="5" bgcolor="#D2E 1F2">
				<div class="campania">
					...
					<input readonly="readonly" class="ultimoElement" name="bodega" type="text" value='{$tabla[0]["bodega"]}'  alt="Bodega" />
				</div>
				<div class="izq clear">
					<p class="azul bold">LIMPIEZA</p>
					<div class="campania">
						<label class="primerElement">Detalle:</label>
						<select name="limpieza_detalle" disabled="disabled">
		...
		<form class="box-coment" name="box_coment" action="/adm_audit_stock_limpieza_detalle_coment/{$id_tabla_proc}.html"
