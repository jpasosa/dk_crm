...
<script type="text/javascript" src="/js/rh_pedido_dias_libres/del_file.js"></script>
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <form class="box-entrada" action="/rh_pedido_dias_libres.html" method="post" enctype="multipart/form-data" >
            <div class="box-entrada" height="40" colspan="5" bgcolor="#D2E1F2">
                ...
                <div class="fecha_fin">
                    ...
                    {else}
                        <input name="fecha_fin" type="text" id="fecha_fin" value='{$tabla[0][fecha_inicio]|date_format:"d/m/Y"}' />
                    {/if}
                </div>
                <div class="cant_dias">
                    <label>Cantidad Días: </label>
                    <input name="cant_dias" type="text" value="{$tabla[0]['cantidad_dias']}" />
                </div>
        ...
        <form class="box-entrada" name="add_hotel" action="/rh_pedido_dias_libres.html" method="post" enctype="multipart/form-data" >
