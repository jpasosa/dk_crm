...
<script type="text/javascript" src="/js/dis_armado_arte_fabrica/del_file.js"></script>
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <form class="box-entrada" name="add_hotel" action="/dis_armado_arte_fabrica.html" method="post" enctype="multipart/form-data" >
