...
<script type="text/javascript" src="/js/ave_comparacion_aerolineas/abm.js"></script>
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(/img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <table width="642" border="0" cellpadding="0" cellspacing="0" class="formulario">
            <tr>
                <td width="70" bgcolor="#4685CA"><p class="blanco">Aerolínea </p></td>
            ...
            {if $tabla_sec['error'] == false }
                ...
                <tr id="id_hotel-{$$ho[id_ave_comparacion_aerolineas_opc]}">
                    <td><span class="hotel">{$$ho[aerolinea]}</span></td>
                    <td><span class="comentario">{$$ho[comentario]}</span></td>
                    <td align="center"><span class="costo">{$$ho[costo]|number_format:2:",":""}</span></td>
                    <td class="archivo" id="{$$ho[id_ave_comparacion_aerolineas_opc]}">
                        {if $$ho['archivo'] != "" }
                            <a href="/upload_archivos/ave_comparacion_aerolineas/{$$ho[archivo]}" target="_blank">
                                <span class="archivo">{$$ho[archivo]}</span>
                            </a>
                            <a class="del_file" id="file-{$$ho[id_ave_comparacion_aerolineas_opc]}" href="#" style="">
                    ...
                    <td>
                        <a href="#" style="float:right;">
                            <img id="id_hotel-{$$ho[id_ave_comparacion_aerolineas_opc]}" class="del_hotel" src="img/iconos/delete.gif" alt="quitar" border="0" />
                        </a> 
                        <a href="#" style="float:right;">
                            <img id="id_hotel-{$$ho[id_ave_comparacion_aerolineas_opc]}" class="edit_hotel" src="img/iconos/edit.gif" alt="editar" border="0" />
                        </a>
                    </td>
                </tr>
                {/foreach}
        ...
        <!-- Carga del nuevo hotel -->
        <form class="box-entrada" name="add_hotel" action="/ave_comparacion_aerolineas.html" method="post" enctype="multipart/form-data" >
            <div class="box-entrada" height="40" colspan="5" bgcolor="#D2E1F2">
                <div class="hotel">
                    <label> aerolínea: </label>
                    <input name="hotel" class="hotel" type="text" value="{$aerolinea}"  />
                </div>
