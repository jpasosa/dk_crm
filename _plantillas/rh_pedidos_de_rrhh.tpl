<link href="/css/rh_pedidos_de_rrhh.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/js/rh_pedidos_de_rrhh/del_file.js"></script>
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <form class="box-entrada" action="/rh_pedidos_de_rrhh.html" method="post" enctype="multipart/form-data" >
        ...
        <form class="box-entrada" name="add_hotel" action="/rh_pedidos_de_rrhh.html" method="post" enctype="multipart/form-data" >
