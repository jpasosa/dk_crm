<link href="/css/crm_mejorar_aplicaciones.css" rel="stylesheet" type="text/css" />
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(/img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <hr />
        <h1 class="azul bold"><span class="txt22 normal">Mejorar Aplicaciones</span></h1>
        <hr />
        ...
        <form class="box-entrada" action="/crm_mejorar_aplicaciones.html" method="post" enctype="multipart/form-data" >
            <div class="box-entrada" height="40" colspan="5" bgcolor="#D2E1F2">
                <div class="asunto">
                    <label>Asunto: </label> mejora
                    <input type="text" readonly="readonly" value="{$tabla[0]['asunto']}" />
                </div>
                <div class="mejora">
                    <label>Mejora : </label>
                    <textarea name="mejora" readonly="readonly">{$tabla[0]['mejora']}</textarea>
                </div>
                {if $files['error'] == false }
                    <div class="archivos">
                        {foreach item=n from=$files}
                            <div class="file">
                                <a class="file_name" target="_blank" id="file_name-{$$n[id]}" href="/upload_archivos/crm_mejorar_aplicaciones/{$$n[nombre]}">
        ...
        <form class="box-coment" name="box_coment" action="/crm_mejorar_aplicaciones_coment/{$id_tabla_proc}.html" method="post" enctype="multipart/form-data" >
