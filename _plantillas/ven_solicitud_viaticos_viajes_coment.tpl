...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    {if $flash_error != '' }
    <div class="disp_error"> {$flash_error} </div>{/if}
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <p>Empleado:<span class="azul">{$nombre_inicio}</span>
        </p>
            ...
            {if $tabla_sec_clientes['error'] != true }
                ...
                {foreach item=cl from=$tabla_sec_clientes }
                    <tr id="id_cl-{$$cl[solicit_cliente]}">
                        <td><span>{$$cl[empresa]} | {$$cl[nombre_sucursal]}</span></td>
        ...
        <hr />
        <form class="box-coment" name="box_coment" action="/ven_solicitud_viaticos_viajes_coment/{$id_tabla_proc}.html" method="post" enctype="multipart/form-data" >
