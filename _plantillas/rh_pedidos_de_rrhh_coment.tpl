...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(/img/fondos/bg_cuenta.jpg) right top repeat-y;" >
                ...
                {if $files['error'] == false }
                    <div class="archivos">
                        {foreach item=n from=$files}
                            <div class="file">
                                <a class="file_name" target="_blank" id="file_name-{$$n[id]}" href="/upload_archivos/rh_pedidos_de_rrhh/{$$n[nombre]}">
        ...
        <form class="box-coment" name="box_coment" action="/rh_pedidos_de_rrhh_coment/{$id_tabla_proc}.html" method="post" enctype="multipart/form-data" >
