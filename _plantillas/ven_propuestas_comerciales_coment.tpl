...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(/img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <p>Teléfono:<span class="azul">{$telefono_cliente}</span></p>
        <form class="box-entrada">
            <div class="box-entrada" height="40" colspan="5" bgcolor="#D2E1F2">
                ...
                <textarea class="marginCero" readonly="readonly">{$tabla[0]['propuesta']}</textarea>
        ...
        <form class="box-coment" name="box_coment" action="/ven_propuestas_comerciales_coment/{$id_tabla_proc}.html" method="post" enctype="multipart/form-data" >
