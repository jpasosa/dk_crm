    ...
    <div id="derecha" class="catalogo" style="background:url(/img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <form class="box-entrada" action="/rh_pedido_adelanto.html" method="post" enctype="multipart/form-data" >
            <div class="box-entrada" height="40" colspan="5" bgcolor="#D2E1F2">
                <div class="monto">
                    <label>Monto: </label>
                    <input type="text" readonly="readonly" value="{$tabla[0]['monto']}" />
                </div>
                ...
                {if $files['error'] == false }
                    <div class="archivos">
                        {foreach item=n from=$files}
                            <div class="file">
                                <a class="file_name" target="_blank" id="file_name-{$$n[id]}" href="/upload_archivos/rh_pedido_adelanto/{$$n[nombre]}">
        ...
        <form class="box-coment" name="box_coment" action="/rh_pedido_adelanto_coment/{$id_tabla_proc}.html" method="post" enctype="multipart/form-data" >
