<link href="/css/ven_pedidos_varios_clientes.css" rel="stylesheet" type="text/css" />
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;">
        ...
        <hr />
        <h1 class="azul bold"><span class="txt22 normal">Pedidos Varios del cliente</span></h1>
        <hr />
        ...
        <form class="box-entrada">
            <div class="box-entrada" height="40" colspan="5" bgcolor="#D2E1F2">
                ...
                <input class="marginCero" id="asunto" type="text" value="{$tabla[0]['asunto']}" readonly="readonly" />
                ...
                {if $files['error'] == false }
                    <div class="archivos">
                        {foreach item=n from=$files}
                            <div class="file">
                                <a class="file_name" id="file_name-{$$n[id]}" href="/upload_archivos/ven_pedidos_varios_clientes/{$$n[nombre]}">
        ...
        <form class="box-coment" name="box_coment" action="/ven_pedidos_varios_clientes_coment/{$id_tabla_proc}.html" method="post" enctype="multipart/form-data" >
