...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <form class="box-entrada" name="add_hotel" action="/ven_cliente.html" method="post" enctype="multipart/form-data" >
            <div class="box-entrada padding10" height="40" colspan="5" bgcolor="#D2E1F2">
                <div class="campania">
                        ...
                        <input class="ultimoElement" readonly="readonly" name="pedido" type="text" value='{$tabla[0]["nombre_pedido"]}' alt="Pedido"/>
                    </div>
            </div>
        </form>
        ...
        <form class="box-coment" name="box_coment" action="/cpr_pedidos_ej_busqueda_coment/{$id_tabla_proc}.html" method="post" enctype="multipart/form-data" >
