<link href="/css/crm_solucionar_bugs.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/js/crm_solucionar_bugs/del_file.js"></script>
...
<div id="fondoCatalogo" style="background:url(/img/fondos/bg_cuenta.jpg) center top repeat-y;">
    ...
    <div id="derecha" class="catalogo" style="background:url(img/fondos/bg_cuenta.jpg) right top repeat-y;" >
        ...
        <hr />
        <h1 class="azul bold"><span class="txt22 normal">Solucionar errores / Mal funcionamientos</span></h1>
        <hr />
        <p class="txt10 uppercase">Fecha de inicio del trámite:<span class="azul"> {$date}</span></p>
        <p>Sector:<span class="azul"> {$area}</span></p>
        <p>Nombre:<span class="azul"> {$nombre_empleado}</span></p>
        <form class="box-entrada" action="/crm_solucionar_bugs.html" method="post" enctype="multipart/form-data" >
            <div class="box-entrada" height="40" colspan="5" bgcolor="#D2E1F2">
                ...
                <div class="reporte">
                    <label>Reporte : </label>
                    <textarea name="reporte">{$tabla[0]['reporte']}</textarea>
                </div>
                <div class="archivo">
        ...
        <form class="box-entrada" name="add_hotel" action="/crm_solucionar_bugs.html" method="post" enctype="multipart/form-data" >
