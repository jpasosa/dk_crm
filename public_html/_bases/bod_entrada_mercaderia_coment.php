...
class bod_entrada_mercaderia_coment extends FormCommon {
	...
	public  function select_tabla_sec ($valores=NULL){
		return "
			 ...
			 WHERE princ.id_bod_entrada_mercaderia_proc = $valores[0];
		";
	}
