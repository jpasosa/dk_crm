...
class form1 {
    ...
    // INSERTO gastos, de los clientes_gastos. Lo usamos con ajax.
    public  function insert_gasto ($valores=NULL){
        return "
            INSERT
            INTO ven_solicitud_viaticos_viajes_gastos
                    (activo, detalle, id_sis_gastos_viajes, id_ven_solicitud_viaticos_viajes_proc, monto)
            VALUES
                    ('1', '$valores[2]', $valores[1], $valores[0], $valores[3])
            ; 
        ";
    }
