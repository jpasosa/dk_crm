...
if(isset($_POST['agregar'])):
    ...
    do { // VALIDACIONES
           $validations = Validations::General(array(
                                    ...
                                    array('field' => $cantidad_dias, 'null' => false, 'notice_error' => 'Debe completar la cantidad de días.'),
                                    array('field' => $fecha_inicio, 'null' => false, 'validation' => 'date', 'notice_error' => 'La fecha de inicio no es correcta o no fue ingresada.'),
                                    array('field' => $fecha_fin, 'null' => false, 'validation' => 'date', 'notice_error' => 'La fecha de finalización no es correcta o no fue ingresada.')
                                    ));
            ...
            if($first_time == 'true'  ) { // 1era VEZ
                ...
                $update_tabla_princ = BDConsulta::consulta('update_tabla_princ', array($id_tabla, $fecha_inicio_unix, $fecha_fin_unix, $cantidad_dias, $observaciones), 'n');
