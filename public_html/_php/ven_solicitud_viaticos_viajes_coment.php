...
$get_tabla_sec_gastos = Process::getTablaSec('', 'gastos', $id_tabla_proc, 'n', 'sis_gastos_viajes');
$flash_error = Common::setErrorMessage($get_tabla_sec_gastos); // Si tuviera error, lo carga en $flash_error para mostrar.
$tpl->asignar('tabla_sec_gastos', $get_tabla_sec_gastos);

// REGISTROS DE TABLA SECUNDARIA CLIENTES
...
$flash_error = Common::setErrorMessage($get_tabla_sec_clientes); // Si tuviera error, lo carga en $flash_error para mostrar.
$tpl->asignar('tabla_sec_clientes', $get_tabla_sec_clientes);

// MONTO TOTAL
$monto_total = Process::getTablaSecTotal('', 'gastos', $id_tabla_proc, 'monto', 'n');
