...
if(isset($_POST['agregar'])):
    ...
    do { // VALIDACIONES
           $validations = Validations::General(array(
                                    ...
                                    array('field' => $mejora, 'null' => false, 'notice_error' => 'Debe ingresar la mejora.')
                                    ));
            ...
            if($first_time == 'true'  ) { // 1era VEZ
                ...
                $update_tabla_princ = BDConsulta::consulta('update_tabla_princ', array($id_tabla, $asunto, $mejora), 's');
                ...
                $update_tabla_princ = BDConsulta::consulta('update_tabla_princ', array($id_tabla, $asunto, $mejora), 'n');
                if(is_null($update_tabla_princ)) {
