...
if(isset($_POST['agregar'])):
    ...
    do { // VALIDACIONES
           $validations = Validations::General(array(
                                    ...
                                    array('field' => $reporte, 'null' => false, 'notice_error' => 'Debe ingresar observaciones.')
                                    ));
            ...
            if($first_time == 'true'  ) { // 1era VEZ
                ...
                $update_tabla_princ = BDConsulta::consulta('update_tabla_princ', array($id_tabla, $asunto, $reporte), 'n');
