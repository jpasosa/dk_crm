...
if($_GET[1] != '' && $_GET[1] > 0)
{
	...
	$first_process = Process::getFirstProcess('tra_ytd_entrada', $get_tabla[0]['id_tra_ytd_entrada']);
	$select_tabla_sec = BDConsulta::consulta('select_tabla_sec', array($first_process[0]['id_tra_ytd_entrada_proc']), 'n');
