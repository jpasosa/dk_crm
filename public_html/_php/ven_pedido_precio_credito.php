...
if(isset($_POST['agregar'])):
    ...
    $ven_cliente = trim($_POST['ven_cliente']);
    ...
    do { // VALIDACIONES
           $validations = Validations::General(array(
            ...
            if($first_time == 'true' ) { // 1era VEZ
                ...
                $update_tabla_princ = BDConsulta::consulta('update_tabla_princ', array($id_tabla, $pedido, $ven_cliente), 'n');
...
$ven_cliente = Process::getValuesSelectRel('ven_cliente_contacto', 'ven_cliente_sucursales', 'ven_cliente', '', '', 'n');
