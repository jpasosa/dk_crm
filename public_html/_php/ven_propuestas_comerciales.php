...
if(isset($_POST['agregar'])):
    ...
    $id_ven_cliente_contacto = $_SESSION['id_client_user'];
    ...
    do { // VALIDACIONES
           $validations = Validations::General(array(
                                    ...
                                    array('field' => $propuesta, 'null' => false, 'notice_error' => 'Debe ingresar una propuesta.')
                                    ));
            ...
            if($first_time == 'true' ) { // 1era VEZ
                ...
                $update_tabla_princ = BDConsulta::consulta('update_tabla_princ', array($id_tabla, $asunto, $propuesta, $id_ven_cliente_contacto), 'n');
