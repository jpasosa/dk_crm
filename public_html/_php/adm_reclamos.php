...
if(isset($_POST['agregar'])):
    ...
    $id_ven_cliente = $_POST['ven_cliente'];
    $id_crp_proveedores = $_POST['proveedor'];
    ...
    do { // VALIDACIONES
           $validations = Validations::General(array(
                                    ...
                                    array('field' => $reclamo, 'null' => false, 'notice_error' => 'Debe ingresar un reclamo.')
                                    ));
            ...
            if($first_time == 'true' ) { // 1era VEZ
                ...
                $update_tabla_princ = BDConsulta::consulta('update_tabla_princ', array($id_tabla, $asunto, $reclamo, $id_ven_cliente_contacto, $id_crp_proveedores), 'n');
        ...
        $tpl->asignar('id_ven_cliente', $id_ven_cliente);
endif;
