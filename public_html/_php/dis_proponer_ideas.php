...
if(isset($_POST['agregar'])):
    ...
    do { // VALIDACIONES
           $validations = Validations::General(array(
                                    array('field' => $asunto, 'null' => false, 'notice_error' => 'Debe ingresar cantidad de días y/o no es válido.'),
            ...
            if($first_time == 'true'  ) { // 1era VEZ
                ...
                $update_tabla_princ = BDConsulta::consulta('update_tabla_princ', array($id_tabla, $asunto, $observaciones), 'n');
