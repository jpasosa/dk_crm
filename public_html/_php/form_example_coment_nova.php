...
$first_process = Process::isFirstProcess('ven_solicitud_viaticos_viajes', $id_tabla_proc);
$tpl->asignar('first_process', $first_process);
$repeat_process = Process::isRepeatProcess('ven_solicitud_viaticos_viajes', $id_tabla_proc);
...
// TABLA PRINCIPAL
$get_tabla = Process::getTabla('ven_solicitud_viaticos_viajes', $id_tabla_proc, 'n');
...
$get_tabla_sec = Process::getTablaSec('ven_solicitud_viaticos_viajes', 'gastos', $id_tabla_proc);
...
// MONTO TOTAL
$monto_total = Process::getTablaSecTotal('ven_solicitud_viaticos_viajes', 'detalle', $id_tabla_proc, 'monto', 'n');
...
// COMENTARIOS
$all_comments = ProcessComments::getAll('ven_solicitud_viaticos_viajes', $id_tabla_proc, 'n');
...
if(isset($_POST['comentario']) && $_POST['comentario'] != '' &&
    ...
    $comentario = ProcessSends::toNextProcess('ven_solicitud_viaticos_viajes', $id_user, $id_tabla_proc, $comment, $accion, 'n');
