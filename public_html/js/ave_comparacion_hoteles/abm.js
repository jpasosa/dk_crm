$(document).ready(function() {
    ...
    //##### ELIMINAR EN GASTOS DE LOS HOTELES #########
    $("body").on("click", ".del_hotel", function(delRef) {
        ...
        if (confirm('Seguro de eliminarlo?')) {
                jQuery.ajax({ 
                        type: "POST", 
                        url: "/ave_comparacion_hoteles.html",
                        dataType: "text",
                        data: {
                        ...
                        success:function(response, status, xhr){
                            ...
                            FlashMessFull(xhr.getResponseHeader("success_query"), 'El Hotel fue eliminado con éxito', 'El Hotel NO pudo ser eliminado.', false, false)
                        },
    ...
    //##### EDITAR EN GASTOS DE LOS HOTELES #########
